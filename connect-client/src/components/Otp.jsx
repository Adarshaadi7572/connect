...
const Otp = () => {
    ...
    const verifyOtpHandler = async () =>{
        try{
            ...
            const response = await axios.post("http://localhost:3000/api/v1//user_signup", payload, config);
    ...
    return (
        ...
        <div className='otp-container'>
            <div className='otp'>
                ...
                <h1 className="text-4xl md:text-sm font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-500 
             drop-shadow-lg animate-pulse text-center mb-10">Otp has been successfully sent to this {email.slice(0,5) +'*****'} mail for email varification</h1>
