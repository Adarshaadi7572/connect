...
const {signup, login, otpsend ,userDetails, getUserDetails, userEducation, deleteUserEducation, userProjects,deleteProject, volunteer,deleteVolunteer, userSkills} = require("../controllers/user_controller");
